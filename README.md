...
Here is a list of topics included (more topics will be added later):
- Univ-approx: 1d-to-1d Universal Approximation Theorm. Major proof written in `Univ-approx/UnivApprox/LipschitzNN.lean` using `Lean 4.15.0`.
